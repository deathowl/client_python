from formats import TextFormat, ProtobufFormat, ProtobufTextFormat


class Formatter(object):
    """ Formatter selects the best format based on request header
    """
